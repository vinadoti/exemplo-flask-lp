...
URL = 'https://5000-teal-armadillo-tvgz7qp5.ws-us17.gitpod.io'
...
def save():
    ...
    # Criando a lista e definindo seus dados  // Definir 'id', utilizae o 'identificação' somando + 1
    ...
    if buscar > '':
        for livro in lista_livros:
            ...
            if buscar.lower() in livro['titulo'].lower() or buscar.lower() in livro['autor'].lower() or buscar.lower() in livro['categoria'].lower():
                # Criando nova lista com os resultados das buscas
